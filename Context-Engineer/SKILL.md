...
- **For Claude Code**: `AI.md` in each directory
- **For Cursor**: `.cursorrules` at root + `AI.md` in subdirectories
...
**Trigger signals**: "maintain", "refresh index", "sync", "update AI.md", "clean up", or automatically suggest after creating/deleting files
...
|---|---|---|---|
| Claude Code | `AI.md` | `AI.md` in each dir | `.claude/settings.json` |
| Cursor | `.cursorrules` | `AI.md` (readable by Cursor too) | `.cursor/rules` |
| Windsurf | `.windsurfrules` | `AI.md` | — |
| Generic / OpenClaw | `AI.md` | `AI.md` | — |

When bootstrapping, detect the user's environment and generate the appropriate files. When in doubt, generate `AI.md` files — they're the most portable format.
